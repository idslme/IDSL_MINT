import yaml, torch, pickle

from IDSL_MINT.FP2MS.FP2MS_msp_pickler import FP2MS_msp_pickler
from IDSL_MINT.FP2MS.FP2MS_Model import FP2MS_Model
from IDSL_MINT.FP2MS.FP2MS_training_function import FP2MS_train
from IDSL_MINT.utils.msp_file_utils import MINT_address_check

def FP2MS_yaml_trainer(yaml_file):
    ...
    yaml_data = yaml_data['MINT_FP2MS_trainer']
    ...
    if perform_msp_pickling:
        ...
        FP2MS_msp_pickler(pkl_deconvoluted_msp_directory,
                          msp_file_directory,
                          msp_file_name,
                          MIN_MZ,
                          MAX_MZ,
